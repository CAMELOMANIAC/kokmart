...
**콕마트(Kokmart)**는 대형마트 3사의 종이 전단지를 AI(Gemini Multimodal Vision API) 기반으로 분석하여 단위당 최저가를 비교하고, 마트 필구 특가 및 쿠팡 대용량 알뜰 팁을 제공하는 스마트 장보기 최적화 앱입니다.
